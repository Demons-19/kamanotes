...
public interface NoteService {
    ...
    /**
     * 查询笔记详情（Caffeine + Redis 多级缓存）
     *
     * @param noteId 笔记ID
     * @return 笔记详情
     */
    ApiResponse<NoteVO> getNoteDetail(Integer noteId);
     ...
     * @return 热度排行榜
     */
    ApiResponse<List<NoteHotRankVO>> getHotRank(Integer limit);
