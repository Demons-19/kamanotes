...
import com.kama.notes.model.vo.note.NoteHotRankVO;
...
public class NoteController {
     ...
     * @return 返回笔记详情的 ApiResponse 对象
     */
    @GetMapping("/notes/{noteId}")
    public ApiResponse<NoteVO> getNoteDetail(
     ...
     * 笔记热度排行榜
     */
    @GetMapping("/notes/hot-rank")
    public ApiResponse<List<NoteHotRankVO>> getHotRank(
            @RequestParam(name = "limit", defaultValue = "10") Integer limit) {
        return noteService.getHotRank(limit);
    }
}
